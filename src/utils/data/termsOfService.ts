export const transactionToS = {
    ...
    version: 1,
    publishedOn: new Date('05 October 2018 14:48 UTC').toISOString()
};

export const chatToS = {
    text: 'Rump pork chop bacon beef ground round, ribeye biltong bresaola buffalo meatloaf shoulder ham hock pancetta. Doner ground round filet mignon, salami prosciutto turkey swine meatball. Sausage cow tri-tip landjaeger. Pork belly jowl porchetta cupim chicken bresaola, shank burgdoggen meatball shankle ground round shoulder picanha pork loin. Flank meatloaf t-bone, frankfurter tail ball tip shank kielbasa short ribs hamburger picanha burgdoggen bresaola boudin landjaeger. Biltong shank buffalo, beef ribs fatback sausage andouille hamburger.',
    version: 1,
