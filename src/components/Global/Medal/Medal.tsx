...
export default function Medal(props: MedalPropsIF) {
    ...
    const goldMedal = (
        <li className={styles.quiz_medal}>
            <div className={`${styles.quiz_medal__circle} ${styles.quiz_medal__circle__gold}`}>
                <span>1</span>
            </div>
    ...
    const silverMedal = (
        <li className={styles.quiz_medal}>
            <div className={`${styles.quiz_medal__circle} ${styles.quiz_medal__circle__silver}`}>
                <span>2</span>
            </div>
            <div className={`${styles.quiz_medal__ribbon} ${styles.quiz_medal__ribbon__left}`} />
            <div className={`${styles.quiz_medal__ribbon} ${styles.quiz_medal__ribbon__right}`} />
    ...
    const bronzeMedal = (
        <li className={styles.quiz_medal}>
            <div className={`${styles.quiz_medal__circle} ${styles.quiz_medal__circle__bronze}`}>
                <span>3</span>
            </div>
            <div className={`${styles.quiz_medal__ribbon} ${styles.quiz_medal__ribbon__left}`} />
            <div className={`${styles.quiz_medal__ribbon} ${styles.quiz_medal__ribbon__right}`} />
