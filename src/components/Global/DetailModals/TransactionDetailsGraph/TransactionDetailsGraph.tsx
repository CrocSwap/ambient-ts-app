...
export default function TransactionDetailsGraph(
    ...
    useEffect(() => {
        if (scaleData !== undefined && chartThemeColors) {
            const d3LineColor = chartThemeColors.accent1?.copy();
            const d3RangeTriangleColor = chartThemeColors.accent1?.copy();
            const d3BandColor = chartThemeColors.accent1?.copy();
