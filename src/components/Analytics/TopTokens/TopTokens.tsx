// import TokenScrolls from '../Analytics/TokenScrolls/TokenScrolls';
...
// import { uniswapTokens } from '../../data/uniswapTokens'
...
export default function TopTokens() {
    ...
    //             <TopTokensCard name={token.name } img={token.logoURI} symbol={token.symbol} key={idx} number={idx + 1} />
