        ...
        <div className={styles.main_container}>
            ...
            <div className={styles.row_container}>
                <p
                    ...
                    onClick={() => sort(SORT_FIELD.name)}
                >
                    Name {arrow(SORT_FIELD.name)}
                </p>
                <p
                    className={styles.pCursor}
                    onClick={() => sort(SORT_FIELD.address)}
                >
                ...
                <p
                    className={styles.pCursor}
                    onClick={() => sort(SORT_FIELD.priceUSD)}
                >
                ...
                <p
                    className={styles.pCursor}
                    onClick={() => sort(SORT_FIELD.tvlTick)}
                >
                ...
                <p
                    className={styles.pCursor}
                    onClick={() => sort(SORT_FIELD.priceUSDChange)}
                >
