...
export default function NFTBannerAccount(props: NFTBannerAccountProps) {
    ...
    const [selectedAvatarType, setSelectedAvatarType] = useState(0);
    ...
    domDebug('selectedNFT', selectedNft?.cachedUrl);
    domDebug('userprofilenft', userProfileNFT);
    domDebug('isautogenerated', isAutoGeneratedAvatar(selectedNft?.cachedUrl));
