...
export const SWAP_BUFFER_MULTIPLIER_SCROLL = 5;
export const LIMIT_BUFFER_MULTIPLIER_MAINNET = 2;
export const LIMIT_BUFFER_MULTIPLIER_SCROLL = 5;
export const RANGE_BUFFER_MULTIPLIER_MAINNET = 2;
export const RANGE_BUFFER_MULTIPLIER_SCROLL = 5;
export const DEPOSIT_BUFFER_MULTIPLIER_MAINNET = 2;
export const DEPOSIT_BUFFER_MULTIPLIER_SCROLL = 5;
