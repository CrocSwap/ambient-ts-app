...
export const SWAP_BUFFER_MULTIPLIER_MAINNET = 5;
export const SWAP_BUFFER_MULTIPLIER_SCROLL = 1.3;
export const LIMIT_BUFFER_MULTIPLIER_MAINNET = 2;
export const LIMIT_BUFFER_MULTIPLIER_SCROLL = 1.3;
export const RANGE_BUFFER_MULTIPLIER_MAINNET = 2;
export const RANGE_BUFFER_MULTIPLIER_SCROLL = 3;
