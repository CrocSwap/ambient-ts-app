...
import { updateRangeWithButton } from './initRangeFunctions';

// interface for React functional component props
interface InitRangePropsIF {
...
function InitRange(props: InitRangePropsIF) {
    const {
    ...
    return (
        <div className={styles.range_width_container} id='range_width'>
            ...
            <div className={styles.range_width_input}></div>
        </div>
    );
}

export default memo(InitRange);
