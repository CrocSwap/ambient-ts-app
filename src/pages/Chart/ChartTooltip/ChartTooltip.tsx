...
export default function ChartTooltip(props: propsIF) {
    ...
    const { chartSettings,isToolbarOpen,isFullScreen } = useContext(ChartContext);
    ...
    const chartTooltip = (
        <ChartTooltipDiv isToolbarOpen={isToolbarOpen} isFuta={isFuta} isFullScreen={isFullScreen}>
