...
// contract AmbientUSDT is ERC20, ERC20Permit {
//     constructor() ERC20("Ambient USDT", "USDT") ERC20Permit("Ambient USDT") {
...
//     function _generateRandomMintAmount() private returns (uint256) {
